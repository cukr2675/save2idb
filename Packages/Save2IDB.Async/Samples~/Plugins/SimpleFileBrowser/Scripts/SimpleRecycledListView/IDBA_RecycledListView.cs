...
namespace SimpleFileBrowser
{
	...
	public class IDBA_RecycledListView : MonoBehaviour
...
#if UNITY_EDITOR || UNITY_STANDALONE || UNITY_WSA || UNITY_WSA_10_0
		[SerializeField]
		private IDBA_FileBrowser fileBrowser;
#endif
...
#pragma warning restore 0649
		...
		private readonly Dictionary<int, IDBA_ListItem> items = new Dictionary<int, IDBA_ListItem>();
		private readonly Stack<IDBA_ListItem> pooledItems = new Stack<IDBA_ListItem>();

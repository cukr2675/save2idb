...
{
	public class IDBA_FileBrowserItem : IDBA_ListItem, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
...
#endif
	{
		...
		#region Variables
		protected IDBA_FileBrowser fileBrowser;
...
#pragma warning restore 0414
		...
		public void SetFileBrowser( IDBA_FileBrowser fileBrowser, IDBA_UISkin skin )
		{
		...
		public void SetSelected( bool isSelected )
		{
			...
			if( multiSelectionToggle ) // Quick links don't have multi-selection toggle
			{
				...
				if( fileBrowser.MultiSelectionToggleSelectionMode && ( !IsDirectory || fileBrowser.PickerMode != IDBA_FileBrowser.PickMode.Files ) )
				{
		...
		public void OnSkinRefreshed( IDBA_UISkin skin, bool isInitialized = true )
		{
			this.skin = skin;

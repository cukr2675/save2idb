...
{
	public class IDBA_FileBrowserFileOperationConfirmationPanel : MonoBehaviour
	{
...
#pragma warning restore 0649
		...
		internal void Show( IDBA_FileBrowser fileBrowser, List<FileSystemEntry> items, OperationType operationType, OnOperationConfirmed onOperationConfirmed )
		{
			Show( fileBrowser, items, null, operationType, onOperationConfirmed );
		}

		internal void Show( IDBA_FileBrowser fileBrowser, List<FileSystemEntry> items, List<int> selectedItemIndices, OperationType operationType, OnOperationConfirmed onOperationConfirmed )
		{
		...
		internal void RefreshSkin( IDBA_UISkin skin )
		{

...
namespace SimpleFileBrowser
{
	...
	[CreateAssetMenu( fileName = "UI Skin (Save2IDB.Async.Samples)", menuName = "yasirkula/SimpleFileBrowser/UI Skin", order = 111 )]
	public class IDBA_UISkin : ScriptableObject
	{
